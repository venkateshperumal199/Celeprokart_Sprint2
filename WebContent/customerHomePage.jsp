  ...
  <div class="row">
    <div class=" col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="https://usatftw.files.wordpress.com/2015/12/gty_495232624_77201140.jpg?w=1000&h=600&crop=1" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">$50</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        <div class="panel-heading">RAQUET</div>
        <div class="panel-body"><img src="https://usatftw.files.wordpress.com/2015/12/gty_495232624_77201140.jpg?w=1000&h=600&crop=1" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">$120</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        <div class="panel-heading">CRICKET BAT</div>
        <div class="panel-body"><img src="https://usatftw.files.wordpress.com/2015/12/gty_495232624_77201140.jpg?w=1000&h=600&crop=1" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">$75</div>
      </div>
    </div>
  </div>
</div><br>
